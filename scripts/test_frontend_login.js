// Script para probar login desde el frontend real
import fetch from 'node-fetch';

const BASE_URL = 'https://heroesvsvillano.onrender.com';

async function testFrontendLogin() {
  console.log('🧪 Probando login desde frontend real...\n');
  ...
  try {
    ...
    const loginResponse = await fetch(`${BASE_URL}/api/auth/login`, {
      ...
      headers: {
        ...
        'Origin': 'https://heroesvsvillano.onrender.com'
      },
      body: JSON.stringify({
